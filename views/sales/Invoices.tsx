...
import { 
  ...
  Calendar, ArrowRight, CheckCircle2, Wallet, Clock, FileDown
} from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm">Manage billing and track customer payments.</p>
        </div>
      </div>
                  ...
                  <tr key={inv.id} className="hover:bg-slate-50/50 transition-colors group">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-indigo-50 text-indigo-600 rounded-lg flex items-center justify-center font-bold text-xs">INV</div>
                        <div>
                    ...
                    <td className="px-6 py-4 text-right font-bold text-slate-700">AED {inv.total.toLocaleString()}</td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="p-2 text-slate-400 hover:text-blue-600"><FileDown size={18} /></button>
